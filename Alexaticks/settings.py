"""
Django settings for Alexaticks project.
...
SECRET_KEY = 'django-insecure-8%obcb&(ju@09=2pn&@3_njz2zs@4+8b#@ol!8-rxk6%-%=@)a'
...
EMAIL_USE_TLS=True
DEFAULT_FROM_EMAIL="codelatincolombia@gmail.com"    # App password de Google
